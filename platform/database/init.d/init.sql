...
INSERT INTO stocks
VALUES
  ('000001', '삼성전자', 720000, @now, @now),
  ('000002', '현대자동차', 682000, @now, @now),
  ('000003', '카카오', 938000, @now, @now),
  ('000004', '네이버', 715000, @now, @now),
  ('000005', 'LG 전자', 153000, @now, @now),
  ('000006', 'SK 하이닉스', 126000, @now, @now),
  ('000007', '아모레퍼시픽', 304000, @now, @now),
  ('000008', '카카오뱅크', 464000, @now, @now),
  ('000009', '쿠팡', 353000, @now, @now),
  ('000010', 'Amazon Inc.', 252000, @now, @now);
